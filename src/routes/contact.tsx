      ...
      <section className="bg-background py-20 lg:py-28">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 lg:grid-cols-5 lg:px-10">
          ...
          <form
            ...
            className="lg:col-span-3 rounded-sm border border-border bg-card p-8 lg:p-10 shadow-card-soft"
          >
            <div className="grid gap-5 md:grid-cols-2">
              <label className="block text-sm">
                <span className="eyebrow !text-[0.65rem]">Full Name</span>
                <input className="mt-2 w-full rounded-sm border border-input bg-background px-3 py-2.5 text-sm focus:border-gold focus:outline-none" />
              </label>
              <label className="block text-sm">
                <span className="eyebrow !text-[0.65rem]">Phone</span>
                <input type="tel" className="mt-2 w-full rounded-sm border border-input bg-background px-3 py-2.5 text-sm focus:border-gold focus:outline-none" />
              </label>
            </div>
            <label className="mt-5 block text-sm">
              <span className="eyebrow !text-[0.65rem]">Email</span>
              <input type="email" className="mt-2 w-full rounded-sm border border-input bg-background px-3 py-2.5 text-sm focus:border-gold focus:outline-none" />
            </label>
            <label className="mt-5 block text-sm">
              <span className="eyebrow !text-[0.65rem]">How can we help?</span>
              <textarea rows={5} className="mt-2 w-full rounded-sm border border-input bg-background px-3 py-2.5 text-sm focus:border-gold focus:outline-none" />
            </label>
