...
const hoods = [
  {
    name: "Westfield",
    img: westfield,
    search: "/search?q=Westfield+NJ",
    note: "Downtown charm, top-rated schools, and a thriving community just 35 minutes from NYC.",
  },
  {
    name: "Summit",
    img: summit,
    search: "/search?q=Summit+NJ",
    note: "One of NJ's most sought-after addresses — walkable, affluent, and consistently strong market.",
  },
  {
    name: "Cranford",
    img: cranford,
    search: "/search?q=Cranford+NJ",
    note: "A riverside gem with strong neighborhood character and excellent value across all price points.",
  },
  {
    name: "Kenilworth",
    img: kenilworth,
    search: "/search?q=Kenilworth+NJ",
    note: "A tight-knit community with easy highway access and outstanding opportunity for buyers.",
  },
];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href="/search"
                  className="inline-flex items-center justify-center rounded-sm bg-navy px-7 py-3.5 text-xs font-semibold uppercase tracking-widest text-white transition-all hover:bg-gold"
                >
                  Search All NJ Listings
                </a>
                <a
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-sm border border-navy px-7 py-3.5 text-xs font-semibold uppercase tracking-widest text-navy transition-all hover:border-gold hover:text-gold"
                >
                  Talk to Our Team
                </a>
              </div>
